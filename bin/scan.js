...
// api routes: scan api/routes/ → generate api/_registry.js
const apiDir = process.argv[3] || 'api'
const routesDir = join(apiDir, 'routes')
...
console.log(`[vue-zero] scanning ${apiDir}/routes`)
syncRegistry(routesDir, apiDir)
